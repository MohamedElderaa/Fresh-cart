...
let validationSchema= Yup.object().shape({
  name:Yup.string().min(3,"Name must be at least 3 letters").max(20,"Name must be at most 20 letters").required("Name is required"),
  email:Yup.string().email("Email is inValid").required("Email is required"),
  password:Yup.string().matches(/^\w{7}[A-Za-z]$/,"Password start with 7 Numbers end with letter and min 8 characters").required("Password is required"),
